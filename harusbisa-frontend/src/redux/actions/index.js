...
export function setFullscreen(fullscreen){
    return {type:SET_FULLSCREEN, payload: fullscreen}
}
export function setLiveQuiz(quizIndex){
    return {type:SET_LIVE_QUIZ, payload: quizIndex}
}